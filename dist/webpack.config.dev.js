...
Encore.configureLoaderRule('less', function (rule) {
  rule.test = /\.less$/;
  rule.use = [{
    loader: 'style-loader'
  }, {
...
.enableStimulusBridge('./assets/controllers.json') // When enabled, Webpack "splits" your files into smaller pieces for greater optimization.
