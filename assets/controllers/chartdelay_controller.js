      ...
      // ctxdelayChart.height = 800; // Définit la hauteur du premier canvas
        ...
        //   });
          ...
          new Chart(ctxAntenne, {
            ...
            data: {
              labels: [
                '<= 5 jours / ' +[achats_delay_all[0]["Pourcentage_Delai_Inf_3_Jours_Ant"]] + "%",
                '> 5 jours / '+[achats_delay_all[0]["Pourcentage_Delai_Sup_3_Jours_Ant"]] + "%",
              ],
              datasets: [{
                label: 'Transmission',
          ...
          new Chart(ctxAppro, {
            ...
            data: {
              labels: [
                '<= 5 jours / ' +[achats_delay_all[2]["Pourcentage_Delai_Inf_7_Jours_Appro"]] + "%",
                '> 5 jours / '+[achats_delay_all[2]["Pourcentage_Delai_Sup_7_Jours_Appro"]] + "%",
              ],
              datasets: [{
                label: 'Notification',
          ...
          new Chart(ctxTotalDelay, {
            ...
            data: {
              labels: [
                '<= 15 jours / ' +[achats_delay_all[3]["Pourcentage_Delai_Inf_15_Jours"]] + "%",
                '> à 15 jours / '+[achats_delay_all[3]["Pourcentage_Delai_Sup_15_Jours"]] + "%",
              ],
              datasets: [{
                label: 'Délai Total',
